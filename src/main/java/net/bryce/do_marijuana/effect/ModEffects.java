...
public class ModEffects {
    public static final HighEffect hungry = new HighEffect(StatusEffectCategory.NEUTRAL, 0);
    ...
    public static void registerEffects(){
        ...
        Registry.register(Registries.STATUS_EFFECT, new Identifier("do_marijuana", "hungry"), hungry);
