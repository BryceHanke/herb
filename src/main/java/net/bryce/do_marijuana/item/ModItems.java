...
import net.bryce.do_marijuana.item.custom.JointItem;
...
public class ModItems {
    ...
    public static final Item MARIJUANA_SEEDS = registerItem("marijuana_seeds",
            new AliasedBlockItem(ModBlocks.MARIJUANA_PLANT, new FabricItemSettings()));

    public static final Item JOINT = registerItem("joint", new JointItem(new FabricItemSettings().maxDamage(9)));
