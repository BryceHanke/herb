...
public class SS_Male_Cannabis_Plant extends Male_Cannabis_Plant {
    public SS_Male_Cannabis_Plant(Settings settings) {super(settings);}
    ...
    public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        ...
        if (random.nextInt((int)(25.0F / f)+1) == 0)
        {
            ...
            if(world.getBlockState(pos.west(1)).isOf(ModBlocks.CD_FEMALE_CANNABIS_PLANT))
            {
                world.setBlockState(pos.west(1), ModBlocks.SD_MALE_CANNABIS_PLANT.getDefaultState(), 2);
            }
            ...
            if(world.getBlockState(pos.east(1)).isOf(ModBlocks.CD_FEMALE_CANNABIS_PLANT))
            {
                world.setBlockState(pos.east(1), ModBlocks.SD_MALE_CANNABIS_PLANT.getDefaultState(), 2);
            }
            ...
            if(world.getBlockState(pos.north(1)).isOf(ModBlocks.CD_FEMALE_CANNABIS_PLANT))
            {
                world.setBlockState(pos.north(1), ModBlocks.SD_MALE_CANNABIS_PLANT.getDefaultState(), 2);
            }
            ...
            if(world.getBlockState(pos.south(1)).isOf(ModBlocks.CD_FEMALE_CANNABIS_PLANT))
            {
                world.setBlockState(pos.south(1), ModBlocks.SD_MALE_CANNABIS_PLANT.getDefaultState(), 2);
            }
        }
