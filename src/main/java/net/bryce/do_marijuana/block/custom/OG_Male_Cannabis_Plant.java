...
public class OG_Male_Cannabis_Plant extends Male_Cannabis_Plant {
    public OG_Male_Cannabis_Plant(Settings settings) {super(settings);
    }
    ...
    public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        ...
        if (random.nextInt((int)(25.0F / f)+1) == 0)
        {
            ...
            {
                world.setBlockState(pos.west(1), ModBlocks.GDK_MALE_CANNABIS_PLANT.getDefaultState(), 2);
            }
            ...
            {
                world.setBlockState(pos.east(1), ModBlocks.GDK_MALE_CANNABIS_PLANT.getDefaultState(), 2);
            }
            ...
            {
                world.setBlockState(pos.north(1), ModBlocks.GDK_MALE_CANNABIS_PLANT.getDefaultState(), 2);
            }
            ...
            {
                world.setBlockState(pos.south(1), ModBlocks.GDK_MALE_CANNABIS_PLANT.getDefaultState(), 2);
            }
