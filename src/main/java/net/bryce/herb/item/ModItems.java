...
public class ModItems {
    ...
    public static final Item WZ_UNTRIMMED_NUG = registerItem("wz_untrimmed_nug", new Item(new FabricItemSettings()));
    public static final Item WZ_TRIMMED_NUG = registerItem("wz_trimmed_nug", new Item(new FabricItemSettings()));
    public static final Item WZ_CURED_NUG = registerItem("wz_cured_nug", new Item(new FabricItemSettings()));
    public static final Item WZ_BUD = registerItem("wz_bud", new Item(new FabricItemSettings()));
    public static final Item WZ_GROUND_WEED = registerItem("wz_ground_weed", new Item(new FabricItemSettings()));

    public static final Item WZ_JAR_OF_TRIMMED = registerItem("wz_jar_of_trimmed", new Jar_Item(new FabricItemSettings().maxDamage(42000).recipeRemainder(ModItems.JAR)));
    public static final Item WZ_JAR_OF_CURED = registerItem("wz_jar_of_cured", new Item(new FabricItemSettings().recipeRemainder(ModItems.JAR)));

    public static final Item WZ_JOINT = registerItem("wz_joint", new Joint_Item(new FabricItemSettings().maxDamage(42)));
    public static final Item WZ_LIT_JOINT = registerItem("wz_lit_joint", new Lit_Joint_Item(new FabricItemSettings().maxDamage(4200)));
    public static final Item WZ_ROACH = registerItem("wz_roach", new Roach_Item(new FabricItemSettings().maxDamage(420)));

    public static final Item WZ_CANNABIS_SEEDS = registerItem("wz_cannabis_seeds",
            new AliasedBlockItem(ModBlocks.WZ_FEMALE_CANNABIS_PLANT, new FabricItemSettings()));

    public static final Item MALE_WZ_CANNABIS_SEEDS = registerItem("male_wz_cannabis_seeds",
            new AliasedBlockItem(ModBlocks.WZ_MALE_CANNABIS_PLANT, new FabricItemSettings()));
