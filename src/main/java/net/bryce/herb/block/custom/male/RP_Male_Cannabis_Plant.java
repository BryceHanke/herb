...
public class RP_Male_Cannabis_Plant extends _Male_Cannabis_Plant {
    public RP_Male_Cannabis_Plant(Settings settings) {super(settings);}
    ...
    public void pollinate(BlockState state, ServerWorld world, BlockPos pos, Random random, Float f)
    {
        ...
        if (random.nextInt((int) (25.0F / f) + 1) == 0) {
            ...
            {
                if (world.getBlockState(positions).getBlock() == ModBlocks.CP_FEMALE_CANNABIS_PLANT || world.getBlockState(positions).getBlock() == ModBlocks.GDP_FEMALE_CANNABIS_PLANT)
                {
