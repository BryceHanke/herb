...
public class ModEffects {
    ...
    public static final CreativeEffect creative = new CreativeEffect(StatusEffectCategory.NEUTRAL, 14144633);
    public static final UpliftedEffect uplifted = new UpliftedEffect(StatusEffectCategory.NEUTRAL, 14144633);

    public static final HeadacheEffect headache = new HeadacheEffect(StatusEffectCategory.HARMFUL, 14144633);
    public static final SleepyEffect sleepy = new SleepyEffect(StatusEffectCategory.HARMFUL, 8284092);
    public static final TinglyEffect tingly = new TinglyEffect(StatusEffectCategory.HARMFUL, 14144633);
    public static final DryEyesEffect dryeyes = new DryEyesEffect(StatusEffectCategory.HARMFUL, 14144633);
    public static final DizzyEffect dizzy = new DizzyEffect(StatusEffectCategory.HARMFUL, 14144633);
    public static final CottonMouthEffect cottonmouth = new CottonMouthEffect(StatusEffectCategory.HARMFUL, 14144633);
    public static final AnxietyEffect anxiety = new AnxietyEffect(StatusEffectCategory.HARMFUL, 14144633);
    ...
    public static void registerEffects(){
        ...
        Registry.register(Registries.STATUS_EFFECT, new Identifier("herb", "giggly"), giggly);
        ...
        Registry.register(Registries.STATUS_EFFECT, new Identifier("herb", "creative"), creative).addAttributeModifier(EntityAttributes.GENERIC_LUCK,"03C3C89D-7037-4B42-869F-B146BCB64D2E", 0.2, EntityAttributeModifier.Operation.MULTIPLY_TOTAL);
        Registry.register(Registries.STATUS_EFFECT, new Identifier("herb", "uplifted"), uplifted);
        Registry.register(Registries.STATUS_EFFECT, new Identifier("herb", "headache"), headache);
        Registry.register(Registries.STATUS_EFFECT, new Identifier("herb", "dryeyes"), dryeyes);
        Registry.register(Registries.STATUS_EFFECT, new Identifier("herb", "dizzy"), dizzy);
        Registry.register(Registries.STATUS_EFFECT, new Identifier("herb", "cottonmouth"), cottonmouth);
        Registry.register(Registries.STATUS_EFFECT, new Identifier("herb", "anxiety"), anxiety);
